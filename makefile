...
kernel_x86 : kernelloader.o irqasm.o hwdetectasm.o vmmasm.o serial.o kernelio.o idt.o memory.o irq.o kbd.o io.o vmm.o hwdetect.o kprintf.o libc.o kernel.o
	@echo "[ LINK ]" $@
